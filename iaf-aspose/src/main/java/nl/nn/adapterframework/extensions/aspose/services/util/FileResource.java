...
/**
 * Deze klasse maakt het mogelijk om een file te delen tussen verschillende objecten en gedelete als het laatste object wordt gedestroyed.
 * <p/>
 * Indien een nieuwe object een nieuwe reference naar de file wil hebben dan moet deze via {@link #copy()} opgevraagd worden.
 * <br/>Als de reference opgeruimd wordt dan moet een {@link #destroy()} worden aangeroepen.
 * 
...
public class FileResource {
	...
	public String toString() {
		return MoreObjects.toStringHelper(this)
				.add("FileResourceCount", fileResourceCount)
				.toString();
	}
