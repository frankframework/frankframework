...
public class PipeLineSessionDebugger implements MethodHandler {
	...
	private PipeLineSessionDebugger(PipeLineSessionBase pipeLineSession, IbisDebugger ibisDebugger) {
		this.pipeLineSession = pipeLineSession;
		this.ibisDebugger = ibisDebugger;
	}
	
	public static PipeLineSessionBase newInstance(PipeLineSessionBase pipeLineSession, IbisDebugger ibisDebugger) throws NoSuchMethodException, IllegalArgumentException, InstantiationException, IllegalAccessException, InvocationTargetException {
