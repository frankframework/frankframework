...
//      m_transformer.setContentHandler(handler);
          ...
          throws SAXException, IOException
  {
	...
	EntityResolver l_entityResolver = m_entityResolver;
    if (l_entityResolver != null)
    {
      return l_entityResolver.resolveEntity(publicId, systemId);
    }
    else
    {
      return null;
          ...
          throws SAXException
  {
	...
	DTDHandler l_dtdHandler = m_dtdHandler;
	if (l_dtdHandler != null)
    {
      l_dtdHandler.notationDecl(name, publicId, systemId);
    }
  }
            ...
            throws SAXException
  {
    ...
    if (l_dtdHandler != null)
    {
      l_dtdHandler.unparsedEntityDecl(name, publicId, systemId, notationName);
    }
  }
  ...
  public void setDocumentLocator(Locator locator)
  {
    ...
    {
    	l_contentHandler.setDocumentLocator(locator);
    }
  }
          ...
          throws SAXException
  {
    ...
    if (l_contentHandler != null)
    {
      l_contentHandler.startPrefixMapping(prefix, uri);
    }
  }
  ...
  public void endPrefixMapping(String prefix) throws SAXException
  {
    ...
    if (l_contentHandler != null)
    {
      l_contentHandler.endPrefixMapping(prefix);
    }
  }
            ...
            throws SAXException
  {
    ...
    if (l_contentHandler != null)
    {
      l_contentHandler.startElement(uri, localName, qName, atts);
    }
  }
          ...
          throws SAXException
  {
    ...
    if (l_contentHandler != null)
    {
      l_contentHandler.endElement(uri, localName, qName);
    }
  }
  ...
  public void characters(char[] ch, int start, int length) throws SAXException
  {
    ...
    if (l_contentHandler != null)
    {
      l_contentHandler.characters(ch, start, length);
    }
  }
          ...
          throws SAXException
  {
    ...
    if (l_contentHandler != null)
    {
      l_contentHandler.ignorableWhitespace(ch, start, length);
    }
  }
          ...
          throws SAXException
  {
    ...
    if (l_contentHandler != null)
    {
      l_contentHandler.processingInstruction(target, data);
    }
  }
  ...
  public void skippedEntity(String name) throws SAXException
  {
    ...
    if (l_contentHandler != null)
    {
      l_contentHandler.skippedEntity(name);
    }
  }
          ...
          throws SAXException
  {
    ...
    LexicalHandler l_lexicalHandler = m_lexicalHandler;
    if (null != l_lexicalHandler)
    {
    	l_lexicalHandler.startDTD(name, publicId, systemId);
    }
  }
  ...
  public void startEntity(String name) throws SAXException
  {
    ...
    if (null != l_lexicalHandler)
    {
      l_lexicalHandler.startEntity(name);
    }
  }
  ...
  public void endEntity(String name) throws SAXException
  {
    ...
    if (null != l_lexicalHandler)
    {
      l_lexicalHandler.endEntity(name);
    }
  }
  ...
  public void comment(char[] ch, int start, int length) throws SAXException
  {
    ...
    if (null != l_lexicalHandler)
    {
      l_lexicalHandler.comment(ch, start, length);
    }
  }
