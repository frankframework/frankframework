...
import org.frankframework.ftp.FtpFileSystemDelegator;

public class FtpFileSystemListener extends FileSystemListener<FTPFileRef, FtpFileSystem> implements FtpFileSystemDelegator {
