/*
   Copyright 2011 the original author or authors, Copyright 2026 WeAreFrank!
...
public class BomInterpretingJsonSmartJsonProvider extends AbstractJsonProvider {
	...
	public BomInterpretingJsonSmartJsonProvider(int parseMode, JsonReaderI<?> mapper){
	...
	public Object parse(InputStream jsonStream, String charset) throws InvalidJsonException {
		try {
			return createParser().parse(StreamUtil.getCharsetDetectingInputStreamReader(jsonStream, charset), mapper);
