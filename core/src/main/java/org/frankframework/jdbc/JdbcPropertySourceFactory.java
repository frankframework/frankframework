...
public class JdbcPropertySourceFactory implements ApplicationContextAware {
	...
	public Properties createPropertySource(String name, String datasourceName) {
		JdbcFacade ibisProp = (JdbcFacade) applicationContext.getAutowireCapableBeanFactory()
				.autowire(JdbcFacade.class, AutowireCapableBeanFactory.AUTOWIRE_BY_NAME, false);
