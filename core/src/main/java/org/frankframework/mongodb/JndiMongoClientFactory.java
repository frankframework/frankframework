...
public class JndiMongoClientFactory extends JndiObjectFactory<MongoClient, MongoClient> implements IMongoClientFactory {
	...
	public static final String GLOBAL_DEFAULT_DATASOURCE_NAME = AppConstants.getInstance()
			.getProperty(DEFAULT_DATASOURCE_NAME_PROPERTY, GLOBAL_DEFAULT_DATASOURCE_NAME_DEFAULT);
