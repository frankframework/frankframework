 ...
 * 	&lt;Resource
		...
		delegate_jndiAuthAlias=""
		delegate_credentials="username for JNDI-lookup to $sys.lookup"
		delegate_principal="password for JNDI-lookup to $sys.lookup"

		userName="username for QueueConnectionFactory"
		userPassword="password for QueueConnectionFactory"
		SSLVendor="j2se"
