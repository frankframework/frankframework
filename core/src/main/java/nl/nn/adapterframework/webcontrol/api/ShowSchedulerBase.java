...
public class ShowSchedulerBase extends Base {

	protected final Response getAllSchedules() throws ApiException {
	...
	protected final Response findSchedule(String jobName, String groupName) throws ApiException {
	...
	protected final Response updateScheduler(Map<String, Object> json) throws ApiException {
		Scheduler scheduler = getScheduler();
	...
	protected final Response updateTrigger(String jobName, String groupName, Map<String, Object> json) {
		Scheduler scheduler = getScheduler();
	...
	protected final Response updateSchedule(String groupName, String jobName, MultipartBody input) throws ApiException {
		return createSchedule(groupName, jobName, input, true);
	}

	protected final Response createSchedule(String groupName, MultipartBody input) {
	...
	protected final Response deleteSchedule(String jobName, String groupName) throws ApiException {
		Scheduler scheduler = getScheduler();
