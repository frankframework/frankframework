 ...
 * <tr><td>{@link #setClientId(boolean) clientId}</td><td>see <a href="https://www.eclipse.org/paho/files/javadoc/org/eclipse/paho/client/mqttv3/MqttClient.html#MqttClient-java.lang.String-java.lang.String-org.eclipse.paho.client.mqttv3.MqttClientPersistence-">MqttClient(java.lang.String serverURI, java.lang.String clientId, MqttClientPersistence persistence)</a></td><td></td></tr>
 * <tr><td>{@link #setBrokerUrl(boolean) brokerUrl}</td><td>see <a href="https://www.eclipse.org/paho/files/javadoc/org/eclipse/paho/client/mqttv3/MqttClient.html#MqttClient-java.lang.String-java.lang.String-org.eclipse.paho.client.mqttv3.MqttClientPersistence-">MqttClient(java.lang.String serverURI, java.lang.String clientId, MqttClientPersistence persistence)</a></td><td></td></tr>
 * <tr><td>{@link #setTopic(boolean) topic}</td><td>see <a href="https://www.eclipse.org/paho/files/javadoc/org/eclipse/paho/client/mqttv3/MqttClient.html#subscribe-java.lang.String-">MqttClient.subscribe(java.lang.String topicFilter)</a></td><td></td></tr>
 * <tr><td>{@link #setQos(int) qos}</td><td>see <a href="https://www.eclipse.org/paho/files/javadoc/org/eclipse/paho/client/mqttv3/MqttClient.html#MqttClient-java.lang.String-java.lang.String-org.eclipse.paho.client.mqttv3.MqttClientPersistence-">MqttClient(java.lang.String serverURI, java.lang.String clientId, MqttClientPersistence persistence)</a></td><td></td></tr>
 * <tr><td>{@link #setCleanSession(boolean) cleanSession}</td><td>see <a href="https://www.eclipse.org/paho/files/javadoc/org/eclipse/paho/client/mqttv3/MqttConnectOptions.html#setCleanSession-boolean-">MqttConnectOptions.setCleanSession(boolean cleanSession)</a></td><td>true</td></tr>
 * <tr><td>{@link #setPersistenceDirectory(String) persistenceDirectory}</td><td>see <a href="https://www.eclipse.org/paho/files/javadoc/org/eclipse/paho/client/mqttv3/persist/MqttDefaultFilePersistence.html">MqttDefaultFilePersistence</a> and <a href="https://www.eclipse.org/paho/files/javadoc/org/eclipse/paho/client/mqttv3/MqttClient.html">MqttClient</a></td><td>true</td></tr>
 * <tr><td>{@link #setAutomaticReconnect(boolean) automaticReconnect}</td><td>see <a href="https://www.eclipse.org/paho/files/javadoc/org/eclipse/paho/client/mqttv3/MqttConnectOptions.html#setAutomaticReconnect-boolean-">MqttConnectOptions.setAutomaticReconnect(boolean automaticReconnect)</a> (apart from this recover job will also try to recover)</td><td>true</td></tr>
