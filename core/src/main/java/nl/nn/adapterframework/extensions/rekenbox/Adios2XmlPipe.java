 ...
 * <tr><td>{@link #setRekenboxSessionKey(String) rekenboxSessionKey}</td><td>key in {@link IPipeLineSession pipeLineSession} to retrieve rekenbox name from</td><td>&nbsp;</td></tr>
