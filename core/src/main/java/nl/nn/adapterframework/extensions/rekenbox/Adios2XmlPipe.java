...
public class Adios2XmlPipe extends FixedForwardPipe {
	 ...
	 * this file contains both "rubrieken" and "records" which together form
	 * the adios message te be send to the calcbox
	 * the most difficult format used is record[recordindex],label[index]:value;
	 * mind the delimiters, where a record has or doest not have an index number and a label likewise.
	 * @param s the string which is converted to XML
	 * @param session the current pipeline session
	 * @return the XML created
	 * @throws PipeRunException thrown when something in the pipeline session fails
	 */
	 ...
	 * @param newAdiosDefinities the adios definitions to be set
	 */
	 ...
	 * @param newRekenbox the name of the rekenbox to be set
	 */
	 ...
	 * @param newRekenboxSessionKey the name of the sessionKey of rekenbox to be set
	 */
	 ...
	 * @param string the NoConversionForward name to be set
	 */
