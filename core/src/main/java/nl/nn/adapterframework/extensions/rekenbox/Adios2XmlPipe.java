...
public class Adios2XmlPipe extends FixedForwardPipe {
	 ...
	 */
	@IbisDoc({"sets URL to pascal file with label-constants generated by ADIOS-utility.", "nnrscons.pas"})
	 ...
	 */
	@IbisDoc({"sets name of rekenbox to be called", ""})
	 ...
	 */
	@IbisDoc({"sets name of key in {@link nl.nn.adapterframework.core.IPipeLineSession pipeLineSession} to retrieve rekenbox name from", ""})
	 ...
	 */
	@IbisDoc({"Sets the name of the forward used when no conversion to XML was performed, because the input was already XML.", "'noconversion'"})
