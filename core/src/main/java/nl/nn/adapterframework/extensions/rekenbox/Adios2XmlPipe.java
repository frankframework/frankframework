...
public class Adios2XmlPipe extends FixedForwardPipe {
	 ...
	 */
	@IbisDoc({"URL to pascal file with label-constants generated by ADIOS-utility.", "nnrscons.pas"})
	 ...
	 */
	@IbisDoc({"name of rekenbox to be called", " "})
	...
	/**
	 * sets name of key in {@link IPipeLineSession pipeLineSession} to retrieve rekenbox name from
	 */
	@IbisDoc({"key in {@link nl.nn.adapterframework.core.IPipeLineSession pipeLineSession} to retrieve rekenbox name from", " "})
	 ...
	 */
	@IbisDoc({"succes, but no conversion took place", ""})
