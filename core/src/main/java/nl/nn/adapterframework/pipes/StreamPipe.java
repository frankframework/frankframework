 ...
 * <tr><td>{@link #setCheckAntiVirus(boolean) checkAntiVirus}</td><td>(only used for parameter <code>httpRequest</code>) when true parts are checked for antivirus scan returncode</td><td>false</td></tr>
