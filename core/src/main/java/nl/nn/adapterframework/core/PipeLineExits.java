 ...
 *   &lt;Exits&gt;
 *      &lt;Exit name="{@value nl.nn.adapterframework.core.PipeLine#DEFAULT_SUCCESS_EXIT_NAME}" state="{@value nl.nn.adapterframework.core.PipeLine.ExitState#SUCCESS_EXIT_STATE}" /&gt;
