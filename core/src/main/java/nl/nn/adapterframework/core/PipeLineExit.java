 ...
 * for examples.
 * <br/><br/>
 * When a Pipeline doesn't have an Exits element configured it will be initialized with one Exit having name {@value nl.nn.adapterframework.core.PipeLine#DEFAULT_SUCCESS_EXIT_NAME} and
 * state {@value nl.nn.adapterframework.core.PipeLine.ExitState#SUCCESS_EXIT_STATE}.
 * <br/><br/>
