...
public interface IExtendedPipe extends IPipe {
	...
	@IbisDoc({"If set and the input is empty, this fixed value is taken as input", ""})
	public void setEmptyInputReplacement(String string);
	public String getEmptyInputReplacement();

	@IbisDoc({"If set <code>true</code>, the result of the pipe is replaced with the original input (i.e. the input before configured replacements of <code>getInputFromSessionKey</code>, <code>getInputFromFixedValue</code> or <code>emptyInputReplacement</code>)", "false"})
	public void setPreserveInput(boolean preserveInput);
	public boolean isPreserveInput();

	@IbisDoc({"If set, the result (before replacing when <code>true</code>) is stored under this session key", ""})
