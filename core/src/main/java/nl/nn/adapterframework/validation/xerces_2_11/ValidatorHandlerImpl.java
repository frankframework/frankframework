...
final class ValidatorHandlerImpl extends ValidatorHandler implements
    DTDHandler, EntityState, PSVIProvider, XMLDocumentHandler {
...
//        Constants.XERCES_FEATURE_PREFIX + Constants.STRINGS_INTERNED_FEATURE;
    ...
    public boolean getFeature(String name)
        ...
        if (name == null) {
            throw new NullPointerException(JAXPValidationMessageFormatter.formatMessage(null, 
...
//        }
    ...
    public void validate(Source source, Result result) 
        ...
        throw new IllegalArgumentException(JAXPValidationMessageFormatter.formatMessage(null, 
    ...
    private class XMLSchemaTypeInfoProvider extends TypeInfoProvider {
        ...
        private void checkStateAttribute() {
            if (!fInStartElement) {
                throw new IllegalStateException(JAXPValidationMessageFormatter.formatMessage(null, 
