...
public class MongoDbSender extends StreamingSenderBase implements HasPhysicalDestination {
	 ...
	 * @ff.default ${"+JndiMongoClientFactory.DEFAULT_DATASOURCE_NAME_PROPERTY+"}
	 */
	public void setDatasourceName(String datasourceName) {
		this.datasourceName = datasourceName;
	}

	/** Database to connect to. Can be overridden by parameter '"+PARAM_DATABASE+"' */
	public void setDatabase(String database) {
		this.database = database;
	}

	/** Collection to act upon. Can be overridden by parameter '"+PARAM_COLLECTION+"' */
	...
	/** Filter. Can contain references to parameters between '"+NAMED_PARAM_START+"' and '"+NAMED_PARAM_END+"'. Can be overridden by parameter '"+PARAM_FILTER+"' */
	public void setFilter(String filter) {
		this.filter = filter;
	}

	/**
	 * Limit to number of results returned. A value of 0 means 'no limit'. Can be overridden by parameter '"+PARAM_LIMIT+"'
	 * @ff.default 0
	 */
