...
import nl.nn.adapterframework.webcontrol.ConfigurationServlet;
 ...
 /**
 * A soap servlet. I originally did not see that {@link SoapRouterServlet} returns dummy soap if not otherwise recognized, so I tried to redo the stuff without using apache rpc (in {@link HttpServlet} in {@link #doPost}. This is currently unused, and I just call do {@link #doGet(HttpServletRequest, HttpServletResponse)}) from {@link SoapRouterServlet#doGet(HttpServletRequest, HttpServletResponse)}.
 *
