...
public class XmlValidatorExtraTest extends PipeTestBase<XmlValidator> {
    ...
    public static Collection<Object[]> data() {
		...
		// Expected outcome can be success, configurationException (for exceptions thrown during configurations stage)
		// and any class that extends Exception that might be thrown during doPipe stage.

		// Note: the tests in Xsd1.1 folder are taken from https://www.w3.org/TR/xmlschema-guide2versioning/ examples
    ...
    public XmlValidatorExtraTest(String testName, String xsdLocation, String xmlLocation, String expectedOutcome, double xsdVersion) {
