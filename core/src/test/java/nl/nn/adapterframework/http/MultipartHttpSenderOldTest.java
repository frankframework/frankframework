...
public class MultipartHttpSenderOldTest extends HttpSenderTestBase<MultipartHttpSenderOld> {

	@Override
	public MultipartHttpSenderOld createSender() {
		return spy(new MultipartHttpSenderOld());
	}

	@Test
	public void simpleMockedMultipartHttp1() throws Throwable {
		MultipartHttpSenderOld sender = getSender();
		...
		try {
			...
			assertEqualsIgnoreCRLF(getFile("simpleMockedMultipartHttp1-Old.txt"), result.trim());
	...
	public void simpleMockedMultipartHttp2() throws Throwable {
		...
		try {
			...
			String result = sender.sendMessageOrThrow(input, pls).asString();
			assertEqualsIgnoreCRLF(getFile("simpleMockedMultipartHttp2-Old.txt"), result.trim());
		} catch (SenderException e) {
			throw e.getCause();
		} finally {
			if (sender != null) {
	...
	public void simpleMockedMultipartHttp3() throws Throwable {
		...
		try {
			...
			String result = sender.sendMessageOrThrow(input, pls).asString();
			assertEqualsIgnoreCRLF(getFile("simpleMockedMultipartHttp3-Old.txt"), result.trim());
		} catch (SenderException e) {
			throw e.getCause();
		} finally {
			if (sender != null) {
	...
	public void simpleMockedMultipartMtom1() throws Throwable {
		...
		try {
			...
			String result = sender.sendMessageOrThrow(input, pls).asString();
			assertEqualsIgnoreCRLF(getFile("simpleMockedMultipartMtom1-Old.txt"), result.trim());
		} catch (SenderException e) {
			throw e.getCause();
		} finally {
			if (sender != null) {
	...
	public void simpleMockedMultipartMtom2() throws Throwable {
		...
		try {
			...
			String result = sender.sendMessageOrThrow(input, pls).asString();
			assertEqualsIgnoreCRLF(getFile("simpleMockedMultipartMtom2-Old.txt"), result.trim());
		} catch (SenderException e) {
			throw e.getCause();
		} finally {
			if (sender != null) {
	...
	public void simpleMockedMultipartMtom3() throws Throwable {
		...
		try {
			...
			String result = sender.sendMessageOrThrow(input, pls).asString();
			assertEqualsIgnoreCRLF(getFile("simpleMockedMultipartMtom3-Old.txt"), result.trim());
		} catch (SenderException e) {
			throw e.getCause();
		} finally {
			if (sender != null) {
