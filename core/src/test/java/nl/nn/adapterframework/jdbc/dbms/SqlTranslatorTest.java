...
public class SqlTranslatorTest {
	...
	public static Collection<Object[]> data() {
		...
		return Arrays.asList(new Object[][]{
				...
				{"oracle", "H2", "INSERT INTO IBISTEMP (tkey,tblob1,tdate,ttimestamp) VALUES (SEQ_IBISTEMP.NEXTVAL,EMPTY_BLOB(),SYSDATE, SYSTIMESTAMP);", "INSERT INTO IBISTEMP (tkey,tblob1,tdate,ttimestamp) VALUES (NEXT VALUE FOR SEQ_IBISTEMP,'',CURRENT_DATE, CURRENT_TIMESTAMP);"},
				{"oracle", "H2", "INSERT INTO IBISTEMP (tkey,tblob1) VALUES (SEQ_IBISTEMP.NEXTVAL,EMPTY_BLOB());", "INSERT INTO IBISTEMP (tkey,tblob1) VALUES (NEXT VALUE FOR SEQ_IBISTEMP,'');"},
