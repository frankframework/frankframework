...
public class OracleToH2TranslatorTest {
	...
	public void testConvertQuerySelect() throws JdbcException, SQLException {
		...
		QueryContext queryContext = new QueryContext(query, null, null, null);
		String result = OracleToH2Translator.convertQuery(null, queryContext, false);
	...
	public void testConvertQuerySelectForUpdate() throws JdbcException, SQLException {
		...
		String expected = "UPDATE TABLE1 SET FIELD2=? WHERE FIELD1=? AND FIELD3=?";
		QueryContext queryContext = new QueryContext(query, null, null, null);
		String result = OracleToH2Translator.convertQuery(null, queryContext, true);
		assertEquals(expected, result);
		assertEquals(1, queryContext.getSimpleParameterList().size());
	}
