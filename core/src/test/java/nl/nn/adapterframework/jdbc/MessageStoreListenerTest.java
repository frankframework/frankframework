...
public class MessageStoreListenerTest extends JdbcTestBase {
	...
	public void testUpdateStatusQueryDone() throws ConfigurationException {
		...
		String expected = "UPDATE IBISSTORE SET TYPE='A',MESSAGEDATE=NOW(),COMMENTS = 'log', EXPIRYDATE = NOW() + 30 WHERE TYPE!='A' AND MESSAGEKEY=?";
	...
	public void testUpdateStatusQueryError() throws ConfigurationException {
		...
		String expected = "UPDATE IBISSTORE SET TYPE='E',MESSAGEDATE=NOW() WHERE TYPE!='E' AND MESSAGEKEY=?";
