...
public class TransformerPoolNamespaceUnawarenessTest {
	...
	public TransformerPool getTransformerPool(String xpath, String stylesheet, int xsltVersion) throws ConfigurationException { 
		// 7.5+
		return TransformerPool.configureTransformer0("transformerpool test", null, null, xpath, stylesheet, "text", false, null, xsltVersion);
		// 7.0
		//return TransformerPool.configureTransformer0("transformerpool test", null, null, xpath, stylesheet, "text", false, null, xsltVersion!=1);
	}
