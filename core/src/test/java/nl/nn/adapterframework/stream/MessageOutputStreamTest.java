...
public class MessageOutputStreamTest {
	...
	public void test31ContentHandlerAsStream() throws Exception {
		...
		try (MessageOutputStream stream = new MessageOutputStream(null, target, (IForwardTarget)null, null, null, null)) {
			try (OutputStream outputstream = stream.asStream()) {
				outputstream.write(testString.getBytes());
			}
	...
	public void testX32ContentHandlerAsWriterError() throws Exception {
		...
		try (MessageOutputStream stream = new MessageOutputStream(null, transformerHandler, (IForwardTarget)null, null, null, null)) {
