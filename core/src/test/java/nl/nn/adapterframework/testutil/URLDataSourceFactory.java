...
public class URLDataSourceFactory extends JndiDataSourceFactory {
	...
	private static final Object[][] TEST_DATASOURCES = {
			...
			{ "MariaDB",   "jdbc:mariadb://localhost:3306/testiaf", 				"testiaf_user", "testiaf_user00", false, "com.mysql.cj.jdbc.MysqlXADataSource" }, // can have only one entry per product key
