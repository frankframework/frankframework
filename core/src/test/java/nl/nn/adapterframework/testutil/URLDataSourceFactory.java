...
public class URLDataSourceFactory extends JndiDataSourceFactory {
	...
	private static final Object[][] TEST_DATASOURCES = {
			...
			{ "MS_SQL",     "jdbc:sqlserver://localhost:1433;database=testiaf;lockTimeout=1000", 	"testiaf_user", "testiaf_user00", false, "com.microsoft.sqlserver.jdbc.SQLServerXADataSource" },
