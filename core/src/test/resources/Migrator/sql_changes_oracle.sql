...
INSERT INTO TESTIAF_USER.DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('insert row', 'Ali Sihab Akcan', 'Migrator/DatabaseChangelog_inserts.xml', SYSTIMESTAMP, 1, '8:3b5772bbfa5a3092a00bc020db46d688', 'sql', '', 'EXECUTED', NULL, NULL, '4.9.1', 'IGNORE');
