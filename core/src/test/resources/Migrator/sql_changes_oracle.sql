...
INSERT INTO TESTIAF_USER.DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('insert row', 'Ali Sihab Akcan', 'Migrator/DatabaseChangelog_inserts.xml', SYSTIMESTAMP, 1, '8:3b5772bbfa5a3092a00bc020db46d688', 'sql', '', 'EXECUTED', NULL, NULL, 'VERSION', 'IGNORE');
...
INSERT INTO TESTIAF_USER.DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('one', 'Niels Meijer', 'Migrator/DatabaseChangelog_plus_changes.xml', SYSTIMESTAMP, 2, '8:6ea8506c569cc02162836312f364217f', 'createTable tableName=DUMMYTABLE', 'Create DUMMYTABLE', 'EXECUTED', NULL, NULL, 'VERSION', 'IGNORE');

DROP TABLE TESTIAF_USER.DUMMYTABLE CASCADE CONSTRAINTS;

INSERT INTO TESTIAF_USER.DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('two', 'Niels Meijer', 'Migrator/DatabaseChangelog_plus_changes.xml', SYSTIMESTAMP, 3, '8:caa85ccb1dfe9e4b59561107126f4740', 'dropTable tableName=DUMMYTABLE', 'Drop DUMMYTABLE', 'EXECUTED', NULL, NULL, 'VERSION', 'IGNORE');

INSERT INTO TESTIAF_USER.DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID, TAG) VALUES ('three', 'Niels Meijer', 'Migrator/DatabaseChangelog_plus_changes.xml', SYSTIMESTAMP, 4, '8:64ea2cfabf5f08738ffa2cfc5ee2f56a', 'tagDatabase', '', 'EXECUTED', NULL, NULL, 'VERSION', 'IGNORE', 'tralala');
