...
8. Usage of 'var'
   ...
   This can become less readable when using the return type of method. To keep code as readable as possible, we only use
...
> [!NOTE]\
> In my experience, it does take some getting used to read code with streams or optionals!
...
statements on the stream to keep things simple -- but it is a judgment call. Sometimes I
