	...
	<xsl:template match="/">	
		<html lang="nl-NL">
			<xsl:call-template name="header">
				...
				<xsl:with-param name="title"><xsl:value-of select="/page/applicationConstants/properties/property[@name='instance.name']"/> - ConsoleGuide</xsl:with-param>
			</xsl:call-template>
			<body>
				...
				<iframe src="http://www.integrationpartners.nl/ibis-adapter-framework/handleiding-iaf-beheerconsole/" frameBorder="0"></iframe>
				<script>
