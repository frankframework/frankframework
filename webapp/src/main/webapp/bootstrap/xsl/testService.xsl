	...
	<xsl:template match="/">
		<html lang="nl-NL">
			<xsl:call-template name="header">
				...
				<xsl:with-param name="title"><xsl:value-of select="/page/applicationConstants/properties/property[@name='instance.name']"/> - Test a Service</xsl:with-param>
			</xsl:call-template>
			<body>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<form class="form-horizontal">
							<fieldset>
								<legend>Service test form</legend>
									<div class="form-group">
										<label for="select-service" class="control-label col-lg-2">Select a service</label>
										<div class="col-lg-3">
