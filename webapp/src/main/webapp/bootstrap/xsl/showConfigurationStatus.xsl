	...
	<xsl:template match="/">				
		<html lang="nl-NL">
			<xsl:call-template name="header">
				...
				<xsl:with-param name="title"><xsl:value-of select="/page/applicationConstants/properties/property[@name='instance.name']"/> - Show ConfigurationStatus</xsl:with-param>
			</xsl:call-template>
			<body>
