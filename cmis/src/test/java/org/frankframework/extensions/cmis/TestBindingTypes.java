...
public class TestBindingTypes extends CmisSenderTestBase {
	...
	private static final String INPUT = """
			<cmis>
				...
				<objectTypeId>cmis:document</objectTypeId>
	...
	private static final String FETCH_RESULT = """
			<cmis>
				...
				<allowableActions>
					<action>canCreateDocument</action>
				</allowableActions>
				<isExactAcl>false</isExactAcl>
				<policyIds>
					<policyId>dummyObjectId</policyId>
				</policyIds>
				<relationships>
	...
	// Result is in BASE64 format
	private static final String CREATE_ACTION_EXPECTED_RESULT = "ZmlsZUlucHV0LnR4dA=="; // fileInput.txt
	private static final String UPDATE_ACTION_EXPECTED_RESULT = "aWQ="; // id

	public static Stream<Arguments> allImplementations() {
		return Stream.of(
				Arguments.of(CmisSessionBuilder.BindingTypes.ATOMPUB, CmisSender.CmisAction.CREATE, INPUT, CREATE_ACTION_EXPECTED_RESULT),
				...
				Arguments.of(CmisSessionBuilder.BindingTypes.ATOMPUB, CmisSender.CmisAction.UPDATE, INPUT, UPDATE_ACTION_EXPECTED_RESULT),
				Arguments.of(CmisSessionBuilder.BindingTypes.ATOMPUB, CmisSender.CmisAction.FETCH, INPUT, FETCH_RESULT),

				Arguments.of(CmisSessionBuilder.BindingTypes.WEBSERVICES, CmisSender.CmisAction.CREATE, INPUT, CREATE_ACTION_EXPECTED_RESULT),
				...
				Arguments.of(CmisSessionBuilder.BindingTypes.WEBSERVICES, CmisSender.CmisAction.UPDATE, INPUT, UPDATE_ACTION_EXPECTED_RESULT),
				Arguments.of(CmisSessionBuilder.BindingTypes.WEBSERVICES, CmisSender.CmisAction.FETCH, INPUT, FETCH_RESULT),

				Arguments.of(CmisSessionBuilder.BindingTypes.BROWSER, CmisSender.CmisAction.CREATE, INPUT, CREATE_ACTION_EXPECTED_RESULT),
				...
				Arguments.of(CmisSessionBuilder.BindingTypes.BROWSER, CmisSender.CmisAction.UPDATE, INPUT, UPDATE_ACTION_EXPECTED_RESULT),
