...
public class CmisSender extends SenderWithParametersBase {
	...
	public void configure() throws ConfigurationException {
		...
		if(getParameterList() != null && (getParameterList().findParameter("authAlias") != null || getParameterList().findParameter("username") != null ) || getParameterList().findParameter("userName") != null ) {
			runtimeSession = true;
		}
		if(!isKeepSession()) {
			runtimeSession = true;
	...
	private CmisObject getCmisObject(Session cmisSession, Element queryElement) throws SenderException, CmisObjectNotFoundException {
