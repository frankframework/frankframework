...
| /opt/frank/plugins        | Contains plugin JARs                                                                                                       | TBD                                                                                                                                                                                                                                                                                                                                                                                           |
...
Though you probably do not need to touch these files, because of the CredentialProvider, environment variables can also be used to replace properties set inside Tomcat specific configuration files such as `server.xml` and `context.xml`.
