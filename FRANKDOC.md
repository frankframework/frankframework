...
| Java annotation | `@ProtectedAttribute` | Attribute setter | Suppresses declaration and inheritance of attribute. Attributes can be re-introduced in derived classes by overriding the setter.|
