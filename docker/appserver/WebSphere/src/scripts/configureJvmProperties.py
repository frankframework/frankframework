...
setJvmProperty( 'scenariosroot1.directory', '${USER_INSTALL_ROOT}/installedApps/DefaultCell01/ibis-adapterframework-test.ear.ear/adapterframework.war/testtool')
