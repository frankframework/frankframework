...
public class TestAppender extends AbstractAppender implements AutoCloseable {
	...
	public static class Builder<B extends Builder<B>> extends AbstractAppender.Builder<B> {
		...
		public TestAppender build() {
			return build(getRootLogger());
		}

		public TestAppender build(String logger) {
			return build(getLogger(logger));
		}

		public TestAppender build(Class<?> logger) {
			return build(getLogger(logger));
		}

		public TestAppender build(Logger logger) {
	...
	private static Logger getLogger(Class<?> className) {
		return (Logger) LogManager.getLogger(className.getCanonicalName());
	}
