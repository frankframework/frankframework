...
DROP ROLE C##ROLE_WEBSPHERE_XA;
CREATE ROLE C##ROLE_WEBSPHERE_XA;
GRANT SELECT ON SYS.DBA_PENDING_TRANSACTIONS TO C##ROLE_WEBSPHERE_XA;
GRANT SELECT ON SYS.DBA_2PC_PENDING TO C##ROLE_WEBSPHERE_XA;
GRANT EXECUTE ON SYS.DBMS_SYSTEM TO C##ROLE_WEBSPHERE_XA;
GRANT SELECT ON SYS.PENDING_TRANS$ TO C##ROLE_WEBSPHERE_XA;

Grant ROLE_WEBSPHERE_XA to c##testiaf_user;
