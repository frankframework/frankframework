...
# create testiaf_user if it does not already exist
if ! [[ -f /home/oracle/setup/log/create_testuser.log ]]; then
    echo "create testiaf_user ......"
    /bin/bash home/oracle/setup/create_testuser.sh >> $LOG_DIR/create_testuser.log
fi
