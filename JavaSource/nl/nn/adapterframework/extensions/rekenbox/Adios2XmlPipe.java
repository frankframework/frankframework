 ...
 *
 * Revision 1.12  2007/12/03 13:36:15  Gerrit van Brakel <gerrit.van.brakel@ibissource.org>
 ...
 * <tr><td>{@link #setRekenboxSessionKey(String) rekenboxSessionKey}</td><td>key in {@link nl.nn.adapterframework.core.PipeLineSession pipeLineSession} to retrieve rekenbox name from</td><td>&nbsp;</td></tr>
...
public class Adios2XmlPipe extends FixedForwardPipe {
	...
	/**
	 * sets name of key in {@link nl.nn.adapterframework.core.PipeLineSession pipeLineSession} to retrieve rekenbox name from 
	 */
