 ...
 * Revision 1.30  2011-03-16 16:37:48  L190409
...
public class WebServiceSender extends HttpSender {
	public static final String version = "$RCSfile: WebServiceSender.java,v $ $Revision: 1.30 $ $Date: 2011-03-16 16:37:48 $";
	...
	protected HttpMethod getMethod(URI uri, String message, ParameterValueList parameters) throws SenderException {
		...
		String soapmsg= soapWrapper.putInEnvelope(message, getEncodingStyle(),serviceNamespaceURI);
