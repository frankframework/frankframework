 ...
 * <tr><td>{@link #setSoapActionURIParam(String) soapActionURIParm}</td><td>parameter to obtain the SOAPActionUri</td><td>&nbsp;</td></tr>
...
public class WebServiceSender extends HttpSender {
	...
	private String serviceNamespaceURIParam="serviceNamespaceURI";
	...
	private Parameter soapActionURIParameter;
	...
	public void configure() throws ConfigurationException {
		...
		if (paramList!=null && StringUtils.isNotEmpty(getSoapActionURIParam())) {
			soapActionURIParameter=paramList.findParameter(getSoapActionURIParam());
			serviceNamespaceURIParameter=paramList.findParameter(getServiceNamespaceURIParam());
			addParameterToSkip(soapActionURIParameter);
	...
	protected HttpMethod getMethod(URI uri, String message, ParameterValueList parameters) throws SenderException {
		...
		if (serviceNamespaceURIParameter!=null) {
			serviceNamespaceURI=parameters.getParameterValue(getServiceNamespaceURIParam()).asStringValue(getServiceNamespaceURI());
		} else {
			serviceNamespaceURI=getServiceNamespaceURI();
		}
		
		String soapActionURI;
		if (soapActionURIParameter!=null) {
			soapActionURI=parameters.getParameterValue(getSoapActionURIParam()).asStringValue(getSoapActionURI());
		} else {
			soapActionURI=getSoapActionURI();
		}

		String soapmsg= soapWrapper.putInEnvelope(message, getEncodingStyleURI(),serviceNamespaceURI);
	...
	public String getSoapActionURIParam() {
		return soapActionURIParam;
	}
	public void setSoapActionURIParam(String soapActionURIParam) {
		this.soapActionURIParam = soapActionURIParam;
	}
	...
	public String getServiceNamespaceURIParam() {
		return serviceNamespaceURIParam;
	}
	public void setServiceNamespaceURIParam(String serviceNamespaceURIParam) {
		this.serviceNamespaceURIParam = serviceNamespaceURIParam;
	}
