...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:cmh="http://nn.nl/XSD/Generic/MessageHeader/1" version="1.0">
	<xsl:output method="text" indent="no"/>
	<xsl:variable name="dot">.</xsl:variable>
	<xsl:variable name="us">_</xsl:variable>
	<xsl:template match="/">
		<xsl:variable name="toLoc">
			<!--xsl:value-of select="soapenv:Envelope/soapenv:Header/cmh:MessageHeader/cmh:To/cmh:Location"/-->
