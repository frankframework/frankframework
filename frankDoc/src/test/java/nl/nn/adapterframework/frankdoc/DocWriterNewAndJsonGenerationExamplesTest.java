...
public class DocWriterNewAndJsonGenerationExamplesTest {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
			...
			{XsdVersion.STRICT, "general-test-digester-rules.xml", "nl.nn.adapterframework.frankdoc.testtarget.plural.config.defaultClassname.Master", "testPluralConflictDefaultOption.xsd", null}
		});
	}
