...
public class NetStorageCmsSigner {
	 ...
	 */
	public NetStorageCmsSigner(URL url, String nonce, String accessToken, NetStorageAction action) {
		this(url, nonce, accessToken, action, SignType.HMACSHA256);
	}
	 ...
	 */
	public NetStorageCmsSigner(URL url, String nonce, String accessToken, NetStorageAction action, SignType signVersion) {
		this.url = url;
		this.nonce = nonce;
