...
public class App {
	...
	public static void main(String[] args) {
		...
		final String accessToken = use_configured_accessToken && StringUtils.isNotEmpty(ACCESS_TOKEN) ? ACCESS_TOKEN
	...
	private static void listMailfolders(String accessToken) {
		...
		for (MailFolder folder : folders) {
			int count = folder.totalItemCount;
			System.out.println("Folder " + folder.displayName +" count: " + count);
		}
