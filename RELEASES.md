...
- The MultipartHttpSender has been replaced with a new version, based on ICollector. The old, already deprecated, version is still available as MultipartHttpSenderOld
