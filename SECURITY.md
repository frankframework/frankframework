...
It is important to remember that the security of your FF! Application is
...
* **Keep your application up-to-date with the latest Frank!Framework release.**
  By updating your FF! Application to the latest version, you ensure that critical vulnerabilities
...
* The IAF_Util configuration should not be used outside of dev environments
...
| 10.2.x  | :white_check_mark: | :white_check_mark:         | Java SE 21  | Jul 17, 2026 |
| 10.1.x  | :x:                | :white_check_mark:         | Java SE 21  | Apr 23, 2026 |
| 10.0.x  | :white_check_mark: | :white_check_mark:         | Java SE 21  | Feb 10, 2026 |
| 9.4.x   | :x:                | :eight_pointed_black_star: | Java SE 17  | Dec 29, 2025 |
| 9.3.x   | :x:                | :x:                        | Java SE 17  | Oct 13, 2025 |
...
Please always update to the latest available release. CVE's are solved on a best-effort basis, on versions not older than 1 year after the initial release date (specified in the table above). For more information see our [Security monitoring procedure](https://github.com/frankframework/frankframework/wiki/Security-monitoring-procedure).

## Reporting a Vulnerability

The Frank!Framework team and our community take security bugs in the Frank!Framework seriously. We appreciate your efforts to
responsibly disclose your findings, and will make every effort to acknowledge your contributions.

If you would like to report a vulnerability in one of our products, or have security concerns regarding Frank!Framework software,
