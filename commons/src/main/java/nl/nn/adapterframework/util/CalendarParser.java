...
public class CalendarParser {
	 ...
	 *         <tt>CalendarParser.UNSET</tt> if the supplied string is not a valid
	 *         ordinal number.
	 */
	 ...
	 *
	 * @return the numeric month, or <tt>CalendarParser.UNSET</tt> if the supplied
	 *         string is not a valid month name.
	 */
	 ...
	 *
	 * @param dateStr date string
	 * @param order   order in which pieces of numeric strings are assigned (should
	 ...
	 *
	 * @param dateStr       date string
	 * @param order         order in which pieces of numeric strings are assigned
	 *                      (should be one of <tt>YY_MM_DD</tt>, <tt>MM_DD_YY</tt>,
	 *                      etc.)
