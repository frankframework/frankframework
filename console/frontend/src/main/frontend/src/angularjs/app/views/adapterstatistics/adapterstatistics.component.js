...
const adapterstatisticsController = function (appService, Api, $stateParams, SweetAlert, $timeout, $filter, appConstants, Debug, Misc) {
  const ctrl = this;
  ...
  ctrl.$onInit = function () {
    ...
    if (appConstants["Statistics.boundaries"]) {
      ...
      appService.appConstants$.subscribe('appConstants', () => ctrl.populateBoundaries()); //Wait for appConstants trigger to load
    }
