...
public class IMSSender extends MQSender {
	...
	private static final Integer  IIH_HEADER_VERSION		= 1;			// MQIIH_VERSION_1 (4 pos)
	private static final Integer  IIH_HEADER_LENGTH			= 84;			// MQIIH_LENGTH_1 (4 pos)
	private static final Integer  IIH_HEADER_ENCODING		= 0;			// MQ reserved (4 pos)
	private static final Integer  IIH_HEADER_CODECHARSET	= 0;			// MQ reserved (4 pos)
	private static final String   IIH_HEADER_FORMAT			= "MQIMSVS ";	// MQFMT-IMS-VAR-STRING (8 pos)
	private				 int      IIH_HEADER_FLAGS			= 0;			// MQIIH-NONE (4 pos)
	...
	private				 String   IIH_HEADER_MFS_AUTH		= "        ";	// Password (8 pos)
