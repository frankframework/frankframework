...
public class ImapMailListener extends MailListener<Message, MimeBodyPart, ImapTestFileSystem> {

	protected ImapTestFileSystem createFileSystem() {
		return new ImapTestFileSystem();
	}
	...
	public void setSession(Session session) {
		getFileSystem().setSession(session);
	}
