...
public class FileSystemActor<F, S extends IBasicFileSystem<F>> {
	...
	protected void actionRequiresAtLeastOneOfTwoParametersOrAttribute(NameAware owner, ParameterList parameterList, FileSystemAction configuredAction, FileSystemAction action, String parameter1, String parameter2, String attributeName, String attributeValue) throws ConfigurationException {
